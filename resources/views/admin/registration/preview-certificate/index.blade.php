  ...
  <body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Waktu target dalam WIB (8 Agustus 2024 jam 15:08 WIB)
            const targetDateWIB = new Date('2024-08-08T15:08:00+07:00'); // +07:00 adalah offset untuk WIB
            ...
            btnSertifikat.addEventListener('click', function(e) {
                ...
                if (localNowWIB < targetDateWIB) {
                    ...
                    alert('Sertifikat belum bisa di Download, Sertifikat dapat di-download pada tanggal 8 Agustus 2024 jam 15:08 WIB.'); // Pesan peringatan
                } else {
