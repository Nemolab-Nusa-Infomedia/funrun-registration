    ...
    <div class="container d-flex justify-content-center align-items-center notif-pembayaran">
        <div class="box mt-3 p-3">
            <div class="row mx-auto">
                <h3 class="fw-bold text-c1 text-center mb-3">PEMBAYARAN ANDA GAGAL</h3>

                <img src="{{ asset('assets/registration/img/register-failed.png') }}" class="mx-auto mb-3" style="width: 500px" alt="">

                <p class="text-center">pembayaran anda <b class="text-danger">belum berhasil</b>, silahkan buka menu profil untuk menyelesaikan transaksi anda </p>
