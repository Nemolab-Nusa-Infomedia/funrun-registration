...
<div class="card p-3">
    <div class="d-flex d-flex justify-content-between">
        <span class="text-dark fw-bold fs-4">Tambah Akun</span>
        <a href="{{ route('akun') }}"><button class="btn btn-info" type="button"><i class="fa-solid fa-arrow-left"></i> Kembali</button></a>
    </div>
